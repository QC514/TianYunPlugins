...
SF_CAPTCHA_API_BASE_URL = 'https://sfeey.linzixuan.top'
...
def sytTokens(payload, deviceId):
    ...
    deviceidmd5 = generate_md5(
        deviceId + f'{t}' + '9.70.02NBF+BE4{@P:@X${Q9BAE>{PAK!D:N*^CNsc' + datamd5 + '705088894ad6ef475bdf4875c9d533b8&2NBF+BE4{@P:@X${Q9BAE>{PAK!D:N*^')
